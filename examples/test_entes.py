...
def main():
    ...
    while time.perf_counter() < end_time and itteration_count < itterations:
        ...
        mag_field = res1["mag_field"]
        cal_factor = res1["cal_faktor"]
        pretty_result = f"Current = {current}, Magnetic Field = {mag_field}, Calibration Faktor = {cal_factor}"
